...
function buildNav({ lang = 'en', breadcrumbs = [], hreflangMap = {} } = {}) {
  ...
  const galleryHref = journalHref + '?open=gallery';
  ...
  <div class="lp-nav-actions">
    ...
    <a href="${galleryHref}" class="lp-nav-icon-btn" aria-label="${rewardsAria}" title="${rewardsAria}">🏆</a>
    <a href="${galleryHref}" class="lp-nav-icon-btn" aria-label="${journalAria}" title="${journalAria}">🖼️</a>
